...
public class DashboardWebController {
    ...
    public String dashboard(
        ...
        model.addAttribute("paymentStatus", dashboardService.paymentStatus(selectedMonth, selectedYear));
        model.addAttribute("annualHistory", dashboardService.annualHistory(selectedYear));
